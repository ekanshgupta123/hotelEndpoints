...
const HotelPage = () => {
            ...
            try {
                ...
                if (hotelsData.length > 0) {
                    ...
                    hotelsData[0].rates.forEach(rate => {
                        ...
                        // Normalize misc_room_type by sorting words if it exists
    ...
    const handleMealSelection = (roomIndex: number, includeMeal: boolean) => {
        ...
        // Automatically set the refund selection if only one combination is available
    ...
    const handleRefundSelection = (roomIndex: number, includeRefund: boolean) => {
        ...
        // Automatically set the meal selection if only one combination is available
